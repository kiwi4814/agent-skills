...
name: claude-design
description: >-
  Produces HTML-based design artifacts such as landing pages, slide decks,
  wireframes, prototypes, posters, animations, and UI explorations. Use when
  the user asks to design, mock up, prototype, visualize, storyboard, or
  compare visual directions, especially when the brief is ambiguous and needs
  concrete options to review.
---
